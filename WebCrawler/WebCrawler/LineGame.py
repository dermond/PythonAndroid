...
if __name__ == '__main__':
  ...
  # 數獨解答資料 (僅填入空白格)
  solution_data = [
  [1,1,3],[1,2,1],[1,3,4],[1,4,2],[1,5,8],[1,6,7],[1,7,5],[1,8,9],[1,9,6],
  [2,1,6],[2,2,9],[2,3,7],[2,4,3],[2,5,5],[2,6,1],[2,7,2],[2,8,4],[2,9,8],
  [3,1,8],[3,2,2],[3,3,5],[3,4,4],[3,5,6],[3,6,9],[3,7,3],[3,8,1],[3,9,7],
  [4,1,9],[4,2,6],[4,3,1],[4,4,8],[4,5,4],[4,6,3],[4,7,7],[4,8,5],[4,9,2],
  [5,1,4],[5,2,5],[5,3,8],[5,4,1],[5,5,7],[5,6,2],[5,7,6],[5,8,3],[5,9,9],
  [6,1,2],[6,2,7],[6,3,3],[6,4,6],[6,5,9],[6,6,5],[6,7,4],[6,8,8],[6,9,1],
  [7,1,5],[7,2,8],[7,3,9],[7,4,7],[7,5,2],[7,6,4],[7,7,1],[7,8,6],[7,9,3],
  [8,1,1],[8,2,4],[8,3,2],[8,4,9],[8,5,3],[8,6,6],[8,7,8],[8,8,7],[8,9,5],
  [9,1,7],[9,2,3],[9,3,6],[9,4,5],[9,5,1],[9,6,8],[9,7,9],[9,8,2],[9,9,4]
]
