...
if __name__ == '__main__':
  ...
  # 數獨解答資料 (僅填入空白格)
  solution_data = [
  [1,1,9],[1,2,6],[1,3,2],[1,4,3],[1,5,7],[1,6,8],[1,7,5],[1,8,1],[1,9,4],
  [2,1,3],[2,2,4],[2,3,5],[2,4,6],[2,5,9],[2,6,1],[2,7,7],[2,8,2],[2,9,8],
  [3,1,7],[3,2,1],[3,3,8],[3,4,4],[3,5,2],[3,6,5],[3,7,3],[3,8,6],[3,9,9],
  [4,1,2],[4,2,5],[4,3,1],[4,4,7],[4,5,4],[4,6,6],[4,7,9],[4,8,8],[4,9,3],
  [5,1,4],[5,2,3],[5,3,6],[5,4,5],[5,5,8],[5,6,9],[5,7,1],[5,8,7],[5,9,2],
  [6,1,8],[6,2,7],[6,3,9],[6,4,2],[6,5,1],[6,6,3],[6,7,6],[6,8,4],[6,9,5],
  [7,1,1],[7,2,8],[7,3,4],[7,4,9],[7,5,3],[7,6,7],[7,7,2],[7,8,5],[7,9,6],
  [8,1,5],[8,2,9],[8,3,7],[8,4,8],[8,5,6],[8,6,2],[8,7,4],[8,8,3],[8,9,1],
  [9,1,6],[9,2,2],[9,3,3],[9,4,1],[9,5,5],[9,6,4],[9,7,8],[9,8,9],[9,9,7]
]
