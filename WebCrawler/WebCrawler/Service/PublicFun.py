...
def getWebDriver(WebDriverType,incognito=True,headless=False,loadPic=True,DataFolderName=""):
    ...
    if not loadPic:
        opts.add_argument("--disable-images")  #無Pic
...
def closeWebDriver(JobID,driver):
    try:
        ...
        logger.error("delete_all_cookies" +str(featuresIndex))
        pass
    ...
    try:
        ...
        logger.error("close:" +str(featuresIndex))
        pass
    try:
       driver.quit()
       
    except:
        logger.error("quit" +str(featuresIndex))
        pass
    try:
        deleteTempDataFolder(str(JobID))
       
    except:
        logger.error("deleteTempDataFolder" +str(featuresIndex))
        pass
